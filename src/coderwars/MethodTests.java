...
public class MethodTests {
  ...
  public void coderTest() {
    ...
    assertEquals(result, Coders2.evenOdd(arr, operations));
  }
  ...
  public void basicTest1() {
    ...
    assertArrayEquals(
        "it should return '" + Arrays.toString(result) + "'", result, MexicanWave.wave("hello"));
    result =
        new String[] {
          "Codewars",
          "cOdewars",
    ...
    assertArrayEquals(
        "it should return '" + Arrays.toString(result) + "'", result, MexicanWave.wave("codewars"));
    result = new String[] {};
    assertArrayEquals(
        "it should return '" + Arrays.toString(result) + "'", result, MexicanWave.wave(""));
    result =
        new String[] {
          "Two words",
          "tWo words",
    ...
    result = new String[] {" Gap ", " gAp ", " gaP "};
    assertArrayEquals(
        "it should return '" + Arrays.toString(result) + "'", result, MexicanWave.wave(" gap "));
  }

  @Test
  public void testFixStringCase() {
  ...
  public void testBonus() {
    ...
    assertEquals((wellConfigured ? "£" : "\u00A3") + "100000", Bonus.bonusTime(10000, true));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "250000", Bonus.bonusTime(25000, true));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "10000", Bonus.bonusTime(10000, false));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "60000", Bonus.bonusTime(60000, false));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "20", Bonus.bonusTime(2, true));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "78", Bonus.bonusTime(78, false));
    assertEquals((wellConfigured ? "£" : "\u00A3") + "678900", Bonus.bonusTime(67890, true));
  }
